<?php
try{
  if ($_REQUEST["mem_headshot"] != '' || $_REQUEST["mem_id"] != '' || $_REQUEST["mem_email"] != '' || $_REQUEST["mem_psw"] != '') {
    ...
    $sql = "insert into member (mem_headshot,mem_id,mem_email,mem_psw) values (:mem_headshot,:mem_id,:mem_email,:mem_psw)";
