...
<header>
    <div class="m_header">
        <div class="navbar">
            ...
            <div class="status">
                <figure>
                    <a href="javascript:;" class="spanLogin">
    ...
    <div id="passwordLightBox" style="display:none">
        <div id="getPassword">
            ...
            <div class="login_password">
                ...
                <p>請輸入帳號註冊時所留的電子<br>
                    郵件地址，以驗證您的資料</p>
                <input type="mail" name="mem_email" id="mem_email" value="" placeholder="輸入E-mail"><br>
    ...
    <div id="registerLightBox" style="display:none">
        <div id="registered">
            ...
            <div class="login_register">
                ...
                <span>*E-mail</span><input type="mail" name="mem_email" id="f_mem_email" value="" placeholder="輸入E-mail"><br>
                ...
                <p>* 為必填欄位，請填妥欄位資訊。</p>
                <a href="jacascript:;" class="btn orange_l" id="repassword">送出</a><br>
            </div>
        </div>
    </div>
    <!-- </form> -->
