      ...
      <div class="outlok_wrap">
        ...
        <div class="outlook_fix">
          ...
          <div class="fix_photo" id="fix">
            <div class="eye_pos">
              <img src="" alt="" class="eye_demo">
            </div>
            <div class="eye_pos">
              <img src="" alt="" class="eye_demo">
            </div>
            <div class="mouse_pos">
              <img src="" alt="" class="mouse_demo">
            </div>
            <div class="others_pos">
              <img src="" alt="" class="others_demo">
            </div>
            <div class="others_pos">
              <img src="" alt="" class="others_demo">
            </div>
    ...
    <script type="text/javascript">
      window.addEventListener("load", function () {
        ...
        $(document).ready(function () {
          // for (let i = 0; i <  )
          $('.eye_items').click(function () {
            // let eye_src = $(".eye_type").attr("src");
            let eye_src = $(".eye_type").attr("src");
            console.log(eye_src);
            let custs = $(".eye_demo").attr("src", eye_src);
            let eye_src2 = $(".eye_type").attr("src");
            let custs2 = $(".eye_demo2").attr("src", eye_src2);
            // console.log(custs);
        ...
        $(document).ready(function () {
          // for (let i = 0; i <  )
          $('.mouse_items').click(function () {
            let mouse_src = $(".mouse_type").attr("src");
            console.log(mouse_src);
            let custss = $(".mouse_demo").attr("src", mouse_src);
          })
        });
        ...
        $(document).ready(function () {
          // for (let i = 0; i <  )
          $('.others_items').click(function () {
            let others_src = $(".others_type").attr("src");
            console.log(others_src);

            let custss = $(".others_demo").attr("src", others_src);
          });;
        ...
        var eyechange = document.querySelector(".eye_demo");
        var mousechange = document.querySelector(".mouse_demo");
        var otherschange = document.querySelector(".others_demo");
        ...
        right[0].addEventListener("click", function () {
          ...
          eyechange.style.transform = "rotate(" + eyerotate + "deg )";
          console.log("yes");
          mouserotate += 15;
          mousechange.style.transform = "rotate(" + mouserotate + "deg )";
          otherrotate += 15;
          otherschange.style.transform = "rotate(" + otherrotate + "deg )";
        });
